...
- [HomeworkFinale-KPMG](https://github.com/dBenf/Big-Data-Engineering/tree/main/HomeworkFinale-KPMG): data analysis on University trends using **Python** for the pre-processing of the data, **MongoDB** for the storage, and **Apache Spark** for the analysis.
## KPMG Hackaton
